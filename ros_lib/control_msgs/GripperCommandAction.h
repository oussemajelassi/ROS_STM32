...
#include "../../ros_lib/control_msgs/GripperCommandActionFeedback.h"
#include "../../ros_lib/control_msgs/GripperCommandActionGoal.h"
#include "../../ros_lib/control_msgs/GripperCommandActionResult.h"
